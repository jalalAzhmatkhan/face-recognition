...
- Task: **1:N identification** (ASM-04). Gallery = multi-view embeddings per user from the head-orientation video (pose buckets keyed by (yaw, pitch) pairs derived from clock positions, e.g., up to 12 positions; the face stays camera-facing throughout — there is no back-of-head segment to discard; see ASM-03, corrected 2026-08-30).
